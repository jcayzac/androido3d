...
LOCAL_CFLAGS    := -DLINUX -I$(LOCAL_PATH)/third_party/fcollada/files/LibXML/include -I$(LOCAL_PATH)/third_party/fcollada/files -I$(LOCAL_PATH)/third_party/stlport/stlport -I$(LOCAL_PATH)/third_party/chromium
LOCAL_SRC_FILES := $(addprefix third_party/fcollada/files/, \
 DLLEntry.cpp \
...
LOCAL_SRC_FILES := $(addprefix core/, \
 cross/bitmap.cc \
 cross/bitmap.h \
 cross/bitmap_dds.cc \
 cross/bitmap_jpg.cc \
...
LOCAL_STATIC_LIBRARIES := fcollada o3dcore libxml libjpeg zlib stdport
