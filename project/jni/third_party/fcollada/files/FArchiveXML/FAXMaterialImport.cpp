...
bool FArchiveXML::LoadEffectStandard(FCDObject* object, xmlNode* baseNode)		
{
	...
	xmlNode* ocMayaParameterNode = NULL;
	...
	ocMayaParameterNode = FindTechnique(extraNode, DAE_OPENCOLLADAMAYA_PROFILE);
	...
	FindParameters(ocMayaParameterNode, parameterNames, parameterNodes);
