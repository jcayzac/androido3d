...
// Convert O3D enums to our protocol buffers enums
			static inline bool set_primitive_type(binary::Primitive& message, Primitive::PrimitiveType value) {
				...
				case Primitive::POINTLIST:
					x = binary::Primitive::POINT_LIST;
					break;
				case Primitive::LINELIST:
					x = binary::Primitive::LINE_LIST;
					break;
				case Primitive::LINESTRIP:
					x = binary::Primitive::LINE_STRIP;
					break;
				case Primitive::TRIANGLELIST:
					x = binary::Primitive::TRIANGLE_LIST;
					break;
				case Primitive::TRIANGLESTRIP:
					x = binary::Primitive::TRIANGLE_STRIP;
					break;
				case Primitive::TRIANGLEFAN:
					x = binary::Primitive::TRIANGLE_FAN;
					break;
				default:
					return false;
				}
			...
			static inline bool set_semantic(binary::VertexSource::Stream& stream, Stream::Semantic value) {
				...
				case Stream::POSITION:
					x = binary::VertexSource::Stream::POSITION;
					break;
				case Stream::NORMAL:
					x = binary::VertexSource::Stream::NORMAL;
					break;
				case Stream::TANGENT:
					x = binary::VertexSource::Stream::TANGENT;
					break;
				case Stream::BINORMAL:
					x = binary::VertexSource::Stream::BINORMAL;
					break;
				case Stream::COLOR:
					x = binary::VertexSource::Stream::COLOR;
					break;
				case Stream::TEXCOORD:
					x = binary::VertexSource::Stream::TEXCOORD;
					break;
				default:
					return false;
				}
			...
			static inline bool set_infinity(binary::Curve& curve, Curve::Infinity pre, Curve::Infinity post) {
				...
				for(size_t i(0); i < 2; ++i) {
					switch(arg[i]) {
					case Curve::CONSTANT:
						x[i] = binary::Curve::CONSTANT;
						break;
					case Curve::LINEAR:
						x[i] = binary::Curve::LINEAR;
						break;
					case Curve::CYCLE:
						x[i] = binary::Curve::CYCLE;
						break;
					case Curve::CYCLE_RELATIVE:
						x[i] = binary::Curve::CYCLE_RELATIVE;
						break;
					case Curve::OSCILLATE:
						x[i] = binary::Curve::OSCILLATE;
						break;
					default:
						return false;
					}
...
// Convert protocol buffer enums back to O3D enums
			static inline bool set_primitive_type(Primitive& primitive, binary::Primitive::Type value) {
				...
				switch(value) {
				case binary::Primitive::POINT_LIST:
					x = Primitive::POINTLIST;
					break;
				case binary::Primitive::LINE_LIST:
					x = Primitive::LINELIST;
					break;
				case binary::Primitive::LINE_STRIP:
					x = Primitive::LINESTRIP;
					break;
				case binary::Primitive::TRIANGLE_LIST:
					x = Primitive::TRIANGLELIST;
					break;
				case binary::Primitive::TRIANGLE_STRIP:
					x = Primitive::TRIANGLESTRIP;
					break;
				case binary::Primitive::TRIANGLE_FAN:
					x = Primitive::TRIANGLEFAN;
					break;
				default:
					return false;
				}
			...
			static inline bool set_semantic(Stream::Semantic& x, binary::VertexSource::Stream::Semantic value) {
				switch(value) {
				case binary::VertexSource::Stream::POSITION:
					x = Stream::POSITION;
					break;
				case binary::VertexSource::Stream::NORMAL:
					x = Stream::NORMAL;
					break;
				case binary::VertexSource::Stream::TANGENT:
					x = Stream::TANGENT;
					break;
				case binary::VertexSource::Stream::BINORMAL:
					x = Stream::BINORMAL;
					break;
				case binary::VertexSource::Stream::COLOR:
					x = Stream::COLOR;
					break;
				case binary::VertexSource::Stream::TEXCOORD:
					x = Stream::TEXCOORD;
					break;
				default:
					return false;
			...
			static inline bool set_infinity(Curve& curve, binary::Curve::Infinity pre, binary::Curve::Infinity post) {
				...
				for(size_t i(0); i < 2; ++i) {
					switch(arg[i]) {
					case binary::Curve::CONSTANT:
						x[i] = Curve::CONSTANT;
						break;
					case binary::Curve::LINEAR:
						x[i] = Curve::LINEAR;
						break;
					case binary::Curve::CYCLE:
						x[i] = Curve::CYCLE;
						break;
					case binary::Curve::CYCLE_RELATIVE:
						x[i] = Curve::CYCLE_RELATIVE;
						break;
					case binary::Curve::OSCILLATE:
						x[i] = Curve::OSCILLATE;
						break;
					default:
						return false;
